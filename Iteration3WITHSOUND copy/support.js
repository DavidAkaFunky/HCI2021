...
{ 
  ...
  message_hover = createDiv("While hovering the correct circle:");
  message_target.id('target_text');
  message_next.id('next_text');
  message_double.id('double_text');
  message_hover.id('hover_text');
  ...
  message_hover.position(10,display_size_pos_y_offset+160);
  ...
  fill(color(0,255,0));
  circle(235,display_size_pos_y_offset+168,25);
  noFill();
  stroke(255,255,255);
  circle(235,display_size_pos_y_offset+168,30);
  noStroke();
